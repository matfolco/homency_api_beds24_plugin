 ...
 * Homency
 * @version 1.0
 Template Name: Page réserver chalet
 */
...
$is_chalet = 1; // Sert à filter en amont selon les logements (pour les pages template spécifiques recherche de chalet ou recherche de logement)
